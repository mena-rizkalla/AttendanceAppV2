...
public class StudentProfile extends AppCompatActivity {
    ...
    TextView StudentName,txt_id,total_days_off,delete_btn,txt_select_to,txt_select_from,get_reports;
        ...
        get_reports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while (calendar.before(endCalendar)) {
                    ...
                    datesInRange.add(date+Common.currentClassName);
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (list.getUnique_ID().equals(intent.getString("id"))
                                    ...
                                    && datesInRange.contains(list.getDate_and_classID())) {
