            ...
            public void onClick(View view) {
                ...
                realm.executeTransaction(new Realm.Transaction() {
                    ...
                    public void execute(Realm realm) {
                        ...
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Attendance_Students_List");
                        HashMap<Object,String> hashMap = new HashMap<>();
                        hashMap.put("studentName",mList.get(getAbsoluteAdapterPosition()).getName_student());
                        hashMap.put("attendance",attendance);
                        hashMap.put("mobNo",mList.get(getAbsoluteAdapterPosition()).getMobileNo_student());
                        hashMap.put("studentRegNo",mList.get(getAbsoluteAdapterPosition()).getMobileNo_student());
                        hashMap.put("classID",mList.get(getAbsoluteAdapterPosition()).getClass_id());
                        hashMap.put("date_and_classID",mRoomID);
                        hashMap.put("unique_ID",mList.get(getAbsoluteAdapterPosition()).getRegNo_student()+mRoomID);
                        reference.child(mList.get(getAbsoluteAdapterPosition()).getRegNo_student()+mRoomID).setValue(hashMap);
                    }
                });
