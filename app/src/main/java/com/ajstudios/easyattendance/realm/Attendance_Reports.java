...
public class Attendance_Reports extends RealmObject {
    ...
    public Attendance_Reports(String date, String monthOnly, String dateOnly, String classId, String date_and_classID, String classname, String subjName, RealmList<Attendance_Students_List> attendance_students_lists) {
        this.date = date;
